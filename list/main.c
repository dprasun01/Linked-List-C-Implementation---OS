...
int main() {
  ...
  list_print(mylist); // 100->...->NULL
  list_remove_at_index(mylist, 3);
  list_print(mylist); // 100->90->70->...->NULL
  ...
  list_print(mylist); // 90->70->...->NULL
  list_remove_at_index(mylist, 6);
  list_print(mylist); // 90->70->60->50->40->20->10->NULL
